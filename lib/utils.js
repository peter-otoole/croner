...
(function(){
  ...
  global.InputError = function () {
    let error = new Error.call( arguments )
    error.name = "InputError"
    return error
  }

  global.InternalError = function () {
    let error = new Error.call( arguments )
 ...
 */
exports.is = {
  url: function ( suspect ) {
    
    if ( !exports.is.string( suspect ) ) {
      return false;
    }
    return validUrl.isWebUri( suspect )
  },
  email: function ( suspect ) {
    return email.validate( suspect )
  }
};
