...
/**
 *
 * @type {{url: exports.is.url, email: exports.is.email, string: function, object: function, array: function, function: function}}
 */
exports.is = {};
types.forEach((type) => {
...
exports.parseExifDate = function (timestamp) {
    ...
    if (!date.isValid()) {
        ...
        if (!date.isValid()) {
            throw InternalError(`Found invalid exif date '${timestamp}', unable to parse`)
        }
    }
