...
module.exports = function () {
    ...
    return {"interface": yargsInterface,
        cli}
}
...
function getInterface () {
    ...
    return yargs.usage(`
 Chronologically orders JPEG files in a folder based on their EXIF creation date. New filenames take the form YYYYMMDD_HHMMss.jpg

 Usage: ${utils.constants.tool_name} [options]

 Examples:
   - ${utils.constants.tool_name} -f ./pictures/ -p ^img.+[.]jpg$
`).option("f", {
        alias: "folder",
